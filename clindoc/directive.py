...
class Directive:
    ...
    :param path: The path of the file where the directive was found.
    """
    ...
    @classmethod
    def from_line(cls,  line: str, line_number: int, path: str):
        """
        ...
        return cls(directive_name, parameters, description, line_number, path)
