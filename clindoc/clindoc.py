...
class Clindoc:
    ...
    | conf_filename   | (str)                                                                                                    | The filename to a JSON configuration file. If provided, the options in the file will overwrite the options provided in the parameters argument. |
